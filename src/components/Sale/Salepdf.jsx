...
const Salepdf = () => {
  ...
  const {saleData, itemData} = location.state;
  ...
  useEffect(() => {
    const fetchCompanyData = async () => {
      try {
        ...
        const customerResp = await axios.get(`http://localhost:4000/c/get/${saleData.customerId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
          ...
          <Document>
            <Page
              ...
              <View style={styles.outBorder}>
                ...
                <View>
                  <Text style={styles.text}>Pay Mode: {saleData.paymentMode} </Text>
              ...
              <View>
                ...
                <View style={styles.tableFooter}>
                  <Text style={styles.textGross}>Qty: {saleData.totalSaledItem}</Text>
                  <Text style={styles.textGross}>Gross Amount: {saleData.saleGrossAmount}</Text>
                </View>
              </View>
              <View style={styles.lowerHalf}>
                <View style={styles.gst}>
                  ...
                  <View style={styles.tableBottom}>
                    <Text style={styles.text}>Total Tax: {(saleData.saleNetAmount - saleData.saleGrossAmount).toFixed(2)}</Text>
                    <Text style={styles.text}>CGST Amount: {saleData.saleCGSTAmount}</Text>
                    <Text style={styles.text}>SGST Amount: {saleData.saleSGSTAmount}</Text>
                    <Text style={styles.text}>Net Amount: {saleData.saleNetAmount}</Text>
                  </View>
                </View>
                <View style={styles.billBottom}>
                  ...
                  <View style={styles.billBottomSec2}>
                    <Text style={styles.textBold}>Net Amount: {saleData.saleNetAmount.toFixed(2)}</Text>
                  </View>
                </View>
              </View>
            </Page>
